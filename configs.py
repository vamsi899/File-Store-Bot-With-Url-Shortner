...
class Config(object):
  ...
  BOT_USERNAME = os.environ.get("BOT_USERNAME", "http://t.me/Cartoonworldtelugu_india09_bot")
  DB_CHANNEL = int(os.environ.get("DB_CHANNEL", "https://t.me/+HRh3QvZJV-Y0ZThl"))
...
╭────[ 🔅FɪʟᴇSᴛᴏʀᴇBᴏᴛ🔅]────⍟
│
├🔸 My Name: CWT™ FileStore Bot(https://t.me/Cartoonworldtelugu_india09_bot)
│
...
"""
  HOME_TEXT = """
Hello, [{}](tg://user?id={})\n\nThis is a Permanent **FileStore Bot** Created by Vamsi
